...
// click yapinca tab sayisi 1 artti
        System.out.println(driver.getWindowHandles().size());
...
//
        ...
        for (String handle : windowHandles) {
            ...
            // switching tabs
            //driver.switchTo().window("CDwindow-D5E2D684CA6BA7597874D01F9EFE53A6");
...
//<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_default" target="_blank">Try it Yourself »</a>
...
//        System.out.println(driver.getWindowHandles().size());
    ...
    public void changeTab3(){
        driver.get("http://www.shaber3.com/");
        //<img src="http://image.writeclouds.com/Images/News/20181228/78864955_yolcu.jpg" width="650" height="350" alt="[ Dr. Ali Demirel yazdı ]">
    driver.findElement(By.xpath("/html/body/div[2]/div[2]/div/div[2]/div[1]/div/div/div[2]/a/h2/b")).click();
    //Unutma, bu dünyada sadece bir yolcusun!

        for(String handle:driver.getWindowHandles()){
            driver.switchTo().window(handle);
            if(driver.getTitle().equals("Unutma, bu dünyada sadece bir yolcusun!")){
                break;
            }
        }
        System.out.println(driver.getWindowHandles().size());
    Assert.assertTrue(driver.getCurrentUrl().contains("1316982"));
    }
